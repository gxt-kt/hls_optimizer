 ...
 * Camera的位姿T_World_From_Body1， 和观测到该路标点的mearsurement
 * Camera位姿T_World_From_Body2。
...
class EdgeReprojection : public Edge {
 public:
  ...
  void SetTranslationImuFromCamera(Eigen::Quaternion<my_type> &qic_,
                                   Vec3 &tic_);
...
//     /// 返回边的类型信息
//     virtual std::string TypeInfo() const override { return
//     "EdgeReprojectionXYZ"; }
